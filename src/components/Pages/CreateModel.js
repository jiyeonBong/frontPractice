...
//점 찍는거 연습하는 페이지
//tlqkf점이 안찍힘.. addline어쩌구 하면 되긴 하는대 커서를 올려야만 점이 보임
//커서 안올려도 점이 보이도록 하는 방법 찾는중임.
  ...
  useEffect(() => {
    ...
    const redDots = [data[5], data[67]]; // Example: Data points at index 2 and 4
    redDots.forEach((dataPoint) => {
      // Add red dots to the specific data points
      chart.addLineSeries({
        color: 'black',
        lineWidth: 0,
        ...
        crosshairMarkerBorderColorSelected: 'black',
        crosshairMarkerBackgroundColorSelected: 'black',
        data: [
